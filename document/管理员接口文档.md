...
- `movieId`：影片 ID，可选
- `hallId`：影厅 ID，可选
- `startTime`：日期，格式 2024-12-01 19:30:00（参考，实际可能不同，以实际为准） ，可选
**响应**：
```json
{
    "code": 1,
        ...
        "records": [
            {
                ...
                "movie": {
                    ...
                    "country": "China",
                    "rating": "PG-13",
                    "synopsis": "人类启动移山计划的前传故事。",
                    "posterUrl": "https://example.com/poster/wandering_earth2.jpg",
                    "backdropUrl": "https://example.com/backdrop/wandering_earth2.jpg",
                    "status": "released",
                    "createdAt": "2025-12-15 09:31:28",
                    "updatedAt": "2025-12-15 09:31:28",
                    "genreList": [
                        {
                            "genreId": 1,
                            "name": "科幻"
                    ...
                    "actorList": [
                        {
                            "actorId": 1,
                            "name": "吴京",
                            "avatarUrl": "https://example.com/actor/wujing.jpg",
                            "roleName": "程心（示例）"
                        },
                        {
                            "actorId": 2,
                            "name": "张译",
                            "avatarUrl": "https://example.com/actor/zhangyi.jpg",
                            "roleName": "雷扬（示例）"
                        }
                    ]
                },
